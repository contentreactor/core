...
return [
	...
	'URL' => 'URL',
	'URL can\'t be empty if the URL content is mandatory.' => 'URL can\'t be empty if the URL content is mandatory.',
	'YouTube video ID' => 'YouTube video ID',
	'Video ID can\'t be empty if the link type is YouTube.' => 'Video ID can\'t be empty if the link type is YouTube.',
	'Email' => 'Email',
