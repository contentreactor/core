...
/***/ "./src/js/blocks/brandslidersection.js":
/*!*********************************************!*\
  !*** ./src/js/blocks/brandslidersection.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions */ \"./src/js/functions.js\");\n\n(0,_functions__WEBPACK_IMPORTED_MODULE_0__.q)('#form-test').addEventListener('submit', function (e) {\n  e.preventDefault();\n  var token = (0,_functions__WEBPACK_IMPORTED_MODULE_0__.q)('#_token');\n  var body = new FormData();\n  body.append(token.getAttribute('name'), token.value);\n  body.append((0,_functions__WEBPACK_IMPORTED_MODULE_0__.q)('#test').id, (0,_functions__WEBPACK_IMPORTED_MODULE_0__.q)('#test').value);\n  fetch('actions/developion-core/test/index', {\n    method: 'POST',\n    mode: 'cors',\n    cache: 'no-cache',\n    credentials: 'same-origin',\n    redirect: 'follow',\n    referrerPolicy: 'no-referrer',\n    body: body\n  }).then(function (response) {\n    return response.json();\n  }).then(function (response) {\n    console.log(response);\n  })[\"catch\"](function (err) {\n    return console.log(err);\n  });\n});\n\n//# sourceURL=webpack:///./src/js/blocks/brandslidersection.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/js/blocks/brandslidersection.js");
/******/ 	
/******/ })()
;